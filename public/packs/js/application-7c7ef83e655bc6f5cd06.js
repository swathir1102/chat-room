...
// Module
exports.push([module.i, ".chat-room {\n  height: 100vh;\n  overflow-y: hidden; }\n  .chat-room .message .content {\n    background-color: #eeeeee;\n    padding: 10px;\n    border-radius: 15 px; }\n  .chat-room .chat-box {\n    position: absolute;\n    bottom: 0;\n    padding: 20px;\n    width: calc(100% - 50px); }\n  .chat-room .chat-box input[type=text] {\n      height: 45px;\n      font-size: 18px;\n      padding: 8px; }\n  .chat-room .chat-box .btn {\n      height: 45px; }\n", "",{"version":3,"sources":["/Users/swathi/Documents/WebEx/chat-room/app/javascript/stylesheets/application.scss"],"names":[],"mappings":"AAAA;EACE,aAAa;EACb,kBAAkB,EAAA;EAFpB;IAKM,yBAAyB;IACzB,aAAa;IACb,oBAAoB,EAAA;EAP1B;IAWI,kBAAkB;IAClB,SAAS;IACT,aAAa;IACb,wBAAwB,EAAA;EAd5B;MAgBM,YAAY;MACZ,eAAe;MACf,YAAY,EAAA;EAlBlB;MAqBM,YAAY,EAAA","file":"application.scss","sourcesContent":[".chat-room {\n  height: 100vh;\n  overflow-y: hidden;\n  .message {\n    .content {\n      background-color: #eeeeee;\n      padding: 10px;\n      border-radius: 15 px;\n    }\n  }\n  .chat-box {\n    position: absolute;\n    bottom: 0;\n    padding: 20px;\n    width: calc(100% - 50px);\n    input[type=text] {\n      height: 45px;\n      font-size: 18px;\n      padding: 8px;\n    }\n    .btn {\n      height: 45px;\n    }\n  }\n}\n"]}]);
// Exports
...
/******/ });
//# sourceMappingURL=application-7c7ef83e655bc6f5cd06.js.map