...
document.addEventListener('turbolinks: load', function () {
  ...
  _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].log(_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions);
  _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.subscriptions.forEach(function (subscription) {
    _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.remove(subscription);
  });
...
// Module
exports.push([module.i, ".chat-room {\n  height: 100vh;\n  overflow-y: scroll; }\n  .chat-room .message {\n    min-height: 59px; }\n  .chat-room .message .content-container {\n      display: inline-block; }\n  .chat-room .message .content-container .content {\n        background-color: #eeeeee;\n        padding: 8px 16px;\n        border-radius: 20px; }\n  .chat-room .message .content-container .author {\n        font-size: 0.8rem;\n        color: #777777;\n        margin-left: 10px; }\n  .chat-room .message.me .content-container {\n      float: right; }\n  .chat-room .message.me .content-container .content {\n        background-color: #007bff;\n        color: white; }\n  .chat-room .chat-box {\n    position: absolute;\n    bottom: 0;\n    padding: 20px;\n    width: calc(100% - 50px); }\n  .chat-room .chat-box input[type=text] {\n      height: 45px;\n      font-size: 18px;\n      padding: 8px; }\n  .chat-room .chat-box .btn {\n      height: 45px; }\n  .card.no-outline {\n  border: none; }\n  .room-link:hover {\n  text-decoration: none; }\n  .room-link .room-card {\n  transition: background-color 0.5s ease;\n  border-radius: 20px; }\n  .room-link .room-card:hover {\n    background-color: #eeeeee; }\n  .room-link .room-card.active {\n    background-color: black; }\n  .room-link .room-card.active .name {\n      color: white; }\n  .room-link .room-card.active .member-count {\n      color: #e0e0e0; }\n  .room-link .room-card .name {\n    font-weight: bold;\n    color: black; }\n  .room-link .room-card .member-count {\n    color: #777777;\n    font-weight: light; }\n  .rooms-sidebar {\n  border-right: 1px solid #eeeeee; }\n  .nav-container {\n  display: inline-block;\n  color: white;\n  float: right; }\n", "",{"version":3,"sources":["/Users/swathi/Documents/WebEx/chat-room/app/javascript/stylesheets/application.scss"],"names":[],"mappings":"AAAA;EACE,aAAa;EACb,kBAAkB,EAAA;EAFpB;IAII,gBAAgB,EAAA;EAJpB;MAMM,qBAAqB,EAAA;EAN3B;QAQQ,yBAAyB;QACzB,iBAAiB;QACjB,mBAAmB,EAAA;EAV3B;QAaQ,iBAAiB;QACjB,cAAc;QACd,iBAAiB,EAAA;EAfzB;MAoBQ,YAAY,EAAA;EApBpB;QAsBU,yBAAyB;QACzB,YAAY,EAAA;EAvBtB;IA6BI,kBAAkB;IAClB,SAAS;IACT,aAAa;IACb,wBAAwB,EAAA;EAhC5B;MAkCM,YAAY;MACZ,eAAe;MACf,YAAY,EAAA;EApClB;MAuCM,YAAY,EAAA;EAKlB;EACE,YAAY,EAAA;EAGd;EAEI,qBAAqB,EAAA;EAFzB;EAKI,sCAAsC;EACtC,mBAAmB,EAAA;EANvB;IAQM,yBAAyB,EAAA;EAR/B;IAWM,uBAAuB,EAAA;EAX7B;MAaQ,YAAY,EAAA;EAbpB;MAgBQ,cAAc,EAAA;EAhBtB;IAoBM,iBAAiB;IACjB,YAAY,EAAA;EArBlB;IAwBM,cAAc;IACd,kBAAkB,EAAA;EAKxB;EACE,+BAA+B,EAAA;EAGjC;EACE,qBAAqB;EACrB,YAAY;EACZ,YAAY,EAAA","file":"application.scss","sourcesContent":[".chat-room {\n  height: 100vh;\n  overflow-y: scroll;\n  .message {\n    min-height: 59px;\n    .content-container {\n      display: inline-block;\n      .content {\n        background-color: #eeeeee;\n        padding: 8px 16px;\n        border-radius: 20px;\n      }\n      .author {\n        font-size: 0.8rem;\n        color: #777777;\n        margin-left: 10px;\n      }\n    }\n    &.me {\n      .content-container {\n        float: right;\n        .content{\n          background-color: #007bff;\n          color: white;\n        }\n      }\n    }\n  }\n  .chat-box {\n    position: absolute;\n    bottom: 0;\n    padding: 20px;\n    width: calc(100% - 50px);\n    input[type=text] {\n      height: 45px;\n      font-size: 18px;\n      padding: 8px;\n    }\n    .btn {\n      height: 45px;\n    }\n  }\n}\n\n.card.no-outline {\n  border: none;\n}\n\n.room-link {\n  &:hover {\n    text-decoration: none;\n  }\n  .room-card {\n    transition: background-color 0.5s ease;\n    border-radius: 20px;\n    &:hover {\n      background-color: #eeeeee;\n    }\n    &.active {\n      background-color: black;\n      .name {\n        color: white;\n      }\n      .member-count {\n        color: #e0e0e0;\n      }\n    }\n    .name {\n      font-weight: bold;\n      color: black;\n    }\n    .member-count {\n      color: #777777;\n      font-weight: light;\n    }\n  }\n}\n\n.rooms-sidebar {\n  border-right: 1px solid #eeeeee;\n}\n\n.nav-container {\n  display: inline-block;\n  color: white;\n  float: right;\n}\n"]}]);
// Exports
...
/******/ });
//# sourceMappingURL=application-a314cae2c0d7322d815e.js.map